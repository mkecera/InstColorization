...
if __name__ == '__main__':
    ...
    epoch_weights = glob.glob(f'checkpoints/coco_mask_tiny_huber/[0-9]*.pth')
    ...
    for weight_file in epoch_weights:
        model.setup_to_test(f'coco_mask_tiny_huber/{weight_file}')
        ...
        print(weight_file, model.get_current_losses()['G'])