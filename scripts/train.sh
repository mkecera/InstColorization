...
python train.py --stage fusion --name coco_mask_tiny_huber --sample_p 1.0 --niter 10 --niter_decay 20 --lr 0.00005 --model train --load_model --display_ncols 4 --fineSize 256 --batch_size 1 --display_freq 500 --print_freq 500 --display_id -1 --save_epoch_freq 10 --train_img_dir $DATASET_DIR